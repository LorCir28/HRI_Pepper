...
def main():
    ...
    parser.add_argument("--sensor", type=str, default="HeadMiddle",
                        help="Sensor: SonarFront, SonarBack, HeadMiddle, LHand, RHand'")
    ...
    memory_service.insertData(memkey[args.sensor],1.0)
    time.sleep(args.duration)
    memory_service.insertData(memkey[args.sensor],0.0)
